...
// Kieu nay co the can thiep vao theme object
...
// InfoStyle nay in de` theme len RootStyle. Dung de avatar khong bi lam blur boi RootStyle
...
function ProfileCover({ profile }) {
  ...
  const handleError = (e) => {
    ...
    e.target.src = `https://raw.githubusercontent.com/coderschool/codercomm-fe/master/public/covers/cover_${imgIndex}.jpeg`;
